# -*- encoding: utf-8 -*-
# stub: google-cloud-text_to_speech 1.1.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "API Client library for the Cloud Text-to-Speech API".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<google-cloud-text_to_speech-v1>.freeze, ["~> 0.0"])
    s.add_runtime_dependency(%q<google-cloud-text_to_speech-v1beta1>.freeze, ["~> 0.0"])
    ...
    s.add_dependency(%q<google-cloud-text_to_speech-v1>.freeze, ["~> 0.0"])
    s.add_dependency(%q<google-cloud-text_to_speech-v1beta1>.freeze, ["~> 0.0"])
