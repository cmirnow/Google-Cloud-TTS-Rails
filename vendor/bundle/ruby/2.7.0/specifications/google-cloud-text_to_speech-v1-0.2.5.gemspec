# -*- encoding: utf-8 -*-
# stub: google-cloud-text_to_speech-v1 0.2.5 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-text_to_speech-v1".freeze
  s.version = "0.2.5"
  ...
  s.summary = "API Client library for the Cloud Text-to-Speech V1 API".freeze
